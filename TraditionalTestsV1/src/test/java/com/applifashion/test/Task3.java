...
public class Task3 extends BaseTest {
    ...
    public void productDetailsTest(){
        ...
        assertThat(reporter.hackathonReporter(3,"Product Details Test", "shoe_img",browser, width+"X"+height,"laptop",productDetails.shoeImageDisplayed()), is(true));
        assertThat(reporter.hackathonReporter(3,"Product Details Test", "quantity_1",browser, width+"X"+height,"laptop",productDetails.isElementDisplayed(By.id("quantity_1"))), is(true));
        assertThat(reporter.hackathonReporter(3,"Product Details Test", ".btn_add_to_cart",browser, width+"X"+height,"laptop",productDetails.isElementDisplayed(By.cssSelector(".btn_add_to_cart"))), is(true));
